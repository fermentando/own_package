...
# File paths
file_paths = [
    #'/viper/ptmp2/ferhi/d3rcrit/10kc/fv01/out/parthenon.prim.00004.phdf',
    '/viper/ptmp2/ferhi/d3rcrit/10kc/fv01/out/parthenon.prim.00005.phdf',
    '/viper/ptmp2/ferhi/d3rcrit/10kc/fv01/out/parthenon.prim.00006.phdf',
    '/viper/ptmp2/ferhi/d3rcrit/10kc/fv01/out/parthenon.prim.00007.phdf',
    '/viper/ptmp2/ferhi/d3rcrit/10kc/fv01/out/parthenon.prim.00008.phdf',
    '/viper/ptmp2/ferhi/d3rcrit/10kc/fv01/out/parthenon.prim.00009.phdf',
    '/viper/ptmp2/ferhi/d3rcrit/10kc/fv01/out/parthenon.prim.00010.phdf',
    #'/viper/ptmp2/ferhi/d3rcrit/10kc/fv01/out/parthenon.prim.00011.phdf',
]
...
for i, file in enumerate(file_paths):
    data0 = read_hdf5(file, fields=['T', 'rho'], n_jobs=4)
    rho = data0['rho'][xrange_[0]:xrange_[1], yrange[0]-50:yrange[1]//2 - 50, zrange[0]:zrange[1]]
    ...
    cn1, cn2, cn3 = centre
    eye0 = (cn1, cn2 - 4 * rho.shape[2], cn3 - 20 * rho.shape[2])
    ...
    pl.camera_position = [eye0, (cn1, cn2 - 1 * rho.shape[2], cn3), (0, 1, 0)]
    
    filename = f"rot_long_box_{i}.png"
    pl.screenshot(filename, transparent_background=True, window_size=[7680, 4320])
...
images = [Image.open(fn) for fn in screenshots]

total_width = sum(img.width for img in images)
max_height = max(img.height for img in images)

# Create a new transparent image with combined width
combined = Image.new('RGBA', (total_width, max_height), (0, 0, 0, 0))  # fully transparent

# Paste images side-by-side
x_offset = 0
for img in images:
    combined.paste(img, (x_offset, 0), img)  # use img as mask to keep transparency
    x_offset += int(0.9*img.width)

a0_width, a0_height = 9933, 14043
combined.save("all_three_volumes_direct.png")
...
def resize_and_crop(image, target_width, target_height):
    ...
    if img_ratio > target_ratio:
        # Image is wider than target, scale height to target and crop width
        ...
        # Image is taller than target, scale width to target and crop height
        ...
        box = (0, top, target_width, top + target_height)
        image = image.crop(box)
    
    return image

# Load your image
combined = Image.open("all_three_volumes_direct.png")

a0_width, a0_height = 9933, 14043

combined_resized = resize_and_crop(combined, a0_width, a0_height)

combined_resized.save("all_three_volumes_A0_fit.png")