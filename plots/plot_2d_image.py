...
if __name__ == "__main__":
    ...
    ds = rd.read_hdf5(filename='/raven/ptmp/ferhi/ISM_slab/100kc/fv01e/out/parthenon.prim.00007.phdf',
                      fields=['rho', 'vel1', 'vel2'])
    rho = ds['rho']
    v1 = ds['vel1']
    v2 = ds['vel2']


    plot_dict = plot_slice(rho, view_dir=2)
    ...
    plot_dict = plot_projection(rho, view_dir=2)
    plot_dict["cbar"].set_label("Colorbar label")
    ...
    plt.savefig('streamline_1.png')

    plot_dict = plot_streamline(v1, v2, mode="average", view_dir=2)
    ...
    plt.savefig('streamline_example.png')

    plot_dict = plot_streamline(v1, v2, mode="slice", view_dir=2)
    plot_dict = plot_line_integral_convolution(
        v1,
        v2,
        mode="slice",
    ...
    plt.savefig('lin_conv_example.png')