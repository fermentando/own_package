...
if __name__ == "__main__":
    ...
    for run_path in run_paths:
        ...
        param_file = os.path.join(sim_input, 'strat.in')
    ...
    run_all_parallel(single_file_paths[start_idx:], outdir=full_output_dir, n_procs=N_procs)
